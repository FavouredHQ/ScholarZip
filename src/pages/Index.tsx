...
const steps = [
  {
    ...
    desc: "Education level, country of origin, target destinations—our AI needs just 60 seconds of your time.",
    step: "01",
  },
  {
    icon: Zap,
    title: "AI Scouts Match You",
    desc: "Our agents scan thousands of funds daily, scoring each one against your unique academic fingerprint.",
    step: "02",
  },
  {
    icon: CheckCircle2,
    title: "Apply & Win",
    desc: "Apply directly through ScholarFlow. Track every application status in one clean dashboard.",
    step: "03",
  },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden pt-16">
        ...
        <div className="relative z-10 container flex flex-col items-center text-center py-28 md:py-40 lg:py-48">
          ...
          <h1 className="font-display text-4xl md:text-6xl lg:text-7xl font-bold text-foreground max-w-4xl leading-[1.1] animate-fade-in opacity-0">
            The World's Scholarships,{" "}
            <span className="text-gradient-gold">Matched to You.</span>
          </h1>

          <p
            className="mt-6 text-lg md:text-xl text-muted-foreground max-w-2xl leading-relaxed animate-fade-in opacity-0"
          ...
          <div
            className="flex flex-col sm:flex-row gap-4 mt-10 animate-fade-in opacity-0"
          ...
          >
            ...
            <Button
              size="lg"
              variant="outline"
              className="text-base px-8 border-border/60"
      ...
      <section className="container py-24">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground mt-3 max-w-xl mx-auto">
            ScholarFlow's AI does the heavy lifting so you can focus on what matters—your education.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map((feature) => (
            <div
              key={feature.step}
              className="relative bg-card rounded-xl border border-border/50 p-8 shadow-card hover:shadow-card-hover transition-all group"
            >
      ...
      <section className="gradient-navy py-24">
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <span className="inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold gradient-gold text-accent-foreground mb-4">
                For Providers
              </span>
              <h2 className="font-display text-3xl md:text-4xl font-bold text-primary-foreground mb-4">
                Reach the Right Students, Instantly
              </h2>
              <p className="text-primary-foreground/70 mb-8 text-lg">
                Post your scholarships and let our AI match them with the most qualified candidates worldwide.
              </p>
              <ul className="space-y-3 mb-8">
                {[
                  "AI-powered candidate matching",
                  "Real-time application tracking",
                  "Reach students across 120+ countries",
                ].map((item) => (
                  <li
                    key={item}
      ...
      <section className="container py-24">
        <div className="text-center max-w-2xl mx-auto">
          <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-4">
            Ready to Let the Money Find You?
          </h2>
          <p className="text-muted-foreground mb-8 text-lg">
            Join thousands of students already matched with life-changing scholarships.
          </p>
          <Button
            size="lg"
            className="gradient-gold text-accent-foreground font-semibold shadow-gold text-base px-10 hover:opacity-90 transition-opacity"
            onClick={() => navigate("/auth?tab=signup")}
          >
      ...
      <footer className="border-t border-border bg-background py-10">
        <div className="container flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-muted-foreground">
            © 2026 ScholarFlow. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
