              ...
              <TabsContent value="login">
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-3">
                    <Button variant="outline" className="w-full gap-2 text-sm" onClick={() => handleSocialLogin("google")}>
                    ...
                    <Button variant="outline" className="w-full gap-2 text-sm" onClick={() => handleSocialLogin("apple")}>
